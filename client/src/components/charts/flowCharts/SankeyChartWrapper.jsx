/**
 * React Wrapper for D3.js Sankey Diagram
 *
 * Data mapping:
...
const queryToConfig = (query) => {
  ...
  return {
    sourceField: columns[0] || null,
    targetField: columns[1] || null,
    series,
  };
};
...
const SankeyChartWrapper = ({ data, config, query, fieldAggregations = {} }) => {
  ...
  useEffect(() => {
    ...
    chartRef.current = createSankeyChart(containerRef.current, chartConfig, rawData, {
...
export default React.memo(SankeyChartWrapper);
