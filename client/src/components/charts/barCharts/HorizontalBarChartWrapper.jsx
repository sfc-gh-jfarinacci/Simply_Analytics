/**
 * React Wrapper for D3.js Horizontal Bar Chart
 * 
 * Handles React lifecycle, container sizing, data aggregation, and updates
 */
import React, { useRef, useEffect, useState } from 'react';
import { createHorizontalBarChart, createTrellisHorizontalBarChart } from './horizontalBarChart';
...
const HorizontalBarChartWrapper = ({ data, config, query, fieldAggregations = {} }) => {
  ...
  useEffect(() => {
    ...
    if (isTrellis) {
      chartRef.current = createTrellisHorizontalBarChart(containerRef.current, chartConfig, chartData, options);
    } else {
      chartRef.current = createHorizontalBarChart(containerRef.current, chartConfig, chartData, options);
    }
...
export default React.memo(HorizontalBarChartWrapper);
