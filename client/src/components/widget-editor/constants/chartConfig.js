...
export const CHART_FORMAT_OPTIONS = {
   ...
   // Flow
    ...
    // Maps
    choropleth: { animate: true, numberFormat: true },
    hexbin: { animate: true, numberFormat: true },

    // New chart types
    heatmap: { showLabels: true, animate: true, numberFormat: true },
    gauge: { animate: true, numberFormat: true },
    radar: { showGrid: true, animate: true, showLegend: true, legendPosition: true, numberFormat: true },
    histogram: { showGrid: true, animate: true, numberFormat: true, axisTitles: true },
  ...
  export const CHART_FORMAT_DEFAULTS = {
    ...
    choropleth: { animate: true },
    hexbin: { animate: true },
    heatmap: { showLabels: false, animate: true },
    gauge: { animate: true },
    radar: { showGrid: true, animate: true, showLegend: true, legendPosition: 'right' },
    histogram: { showGrid: true, showLabels: false, animate: true, labelColor: '#a0a0b0', xAxisTitle: '', yAxisTitle: '' },
  ...
  export const getChartDataMapping = (chartType) => {
    ...
    switch (chartType) {
      ...
      case 'scatter':
        return {
          ...defaultMapping,
          columnsRole: 'xMeasure',
          rowsRole: 'yMeasure',
          valuesRole: 'size',
        };

      case 'choropleth':
        return { ...defaultMapping, columnsRole: 'geoField', rowsRole: 'yAxis', valuesRole: 'ignored' };

      case 'hexbin':
        return { ...defaultMapping, columnsRole: 'latLng', rowsRole: 'yAxis', valuesRole: 'ignored' };

      case 'heatmap':
        return { ...defaultMapping, columnsRole: 'xAxis', rowsRole: 'yAxis', valuesRole: 'cellValue' };

      case 'gauge':
        return { ...defaultMapping, columnsRole: 'ignored', rowsRole: 'yAxis', valuesRole: 'ignored' };

      case 'radar':
        return { ...defaultMapping, columnsRole: 'xAxis', rowsRole: 'yAxis', valuesRole: 'ignored' };
    ...
    switch (type) {
      ...
      case 'heatmap':
        return {
          ...defaultConfig,
          columnsLabel: 'X-Axis',
          columnsPlaceholder: 'Dimension for columns',
          columnsHint: 'Values become column headers of the matrix',
          rowsLabel: 'Y-Axis',
          rowsPlaceholder: 'Dimension for rows',
          rowsHint: 'Values become row headers of the matrix',
          valuesLabel: 'Value',
          valuesPlaceholder: 'Measure',
          valuesHint: 'Numeric value at each cell — shown as color intensity',
          minColumns: 1, maxColumns: 1, minRows: 1, maxRows: 1, minValues: 1, maxValues: 1,
        };
      ...
      case 'gauge':
        return {
          ...defaultConfig,
          columnsLabel: 'Not Used',
          columnsHint: 'Not applicable for gauge',
          rowsLabel: 'Measure',
          rowsPlaceholder: 'KPI measure',
          rowsHint: 'Single numeric value shown on the gauge arc',
          valuesLabel: 'Not Used',
          valuesHint: 'Not applicable for gauge',
          minColumns: 0, maxColumns: 0, minRows: 1, maxRows: 1, minValues: 0, maxValues: 0,
        };
      ...
      case 'radar':
        return {
          ...defaultConfig,
          columnsLabel: 'Axes',
          columnsPlaceholder: 'Dimension + optional series',
          columnsHint: 'First field = spoke labels (min 3 values), second (optional) = series',
          rowsLabel: 'Value',
          rowsPlaceholder: 'Measure',
          rowsHint: 'Numeric value for each axis spoke',
          valuesLabel: 'Not Used',
          valuesHint: 'Not applicable for radar',
          minColumns: 1, maxColumns: 2, minRows: 1, maxRows: 1, minValues: 0, maxValues: 0,
        };
      ...
      case 'histogram':
        return {
          ...defaultConfig,
          columnsLabel: 'Not Used',
          columnsHint: 'Not applicable for histogram',
          rowsLabel: 'Value',
          rowsPlaceholder: 'Numeric field',
          rowsHint: 'Continuous numeric field whose distribution is shown',
          valuesLabel: 'Not Used',
          valuesHint: 'Not applicable for histogram',
          minColumns: 0, maxColumns: 0, minRows: 1, maxRows: 1, minValues: 0, maxValues: 0,
        };
      ...
      case 'choropleth':
        return {
          ...defaultConfig,
          columnsLabel: 'Location',
          columnsPlaceholder: 'Geographic dimension',
          columnsHint: 'Country name, state abbreviation, or geo code',
          rowsLabel: 'Measure',
          rowsPlaceholder: 'Value to color by',
          rowsHint: 'Numeric measure shown as color intensity',
          minColumns: 1, maxColumns: 1, minRows: 1, maxRows: 1,
        };
      ...
      case 'hexbin':
        return {
          ...defaultConfig,
          columnsLabel: 'Lat / Lng',
          columnsPlaceholder: 'Latitude then Longitude fields',
          columnsHint: 'First field = latitude, second = longitude',
          rowsLabel: 'Value (optional)',
          rowsPlaceholder: 'Measure to aggregate in bins',
          rowsHint: 'Summed per hex bin; omit for point count',
          minColumns: 2, maxColumns: 2, minRows: 0, maxRows: 1,
        };
